...
#
# create_proj.tcl: Tcl script for re-creating project 'project'
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/const/io.xdc"]"\
  ]
  foreach ifile $files {
...
set file "[file normalize "$origin_dir/const/io.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/const/io.xdc"
